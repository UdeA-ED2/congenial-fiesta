...
float2bcd:
    ...
    li   t2, 0x2D           # asumimos negativo
    blt  t0, zero, 1f       # si t0 < 0, salta y deja 0x2D
    li   t2, 0x2B           # si llegó aquí, era positivo
1:
    ...
    # ---------- EXPONENTE ------------------
    fmv.x.w t0, fa0
    lui t2, 0x7F800           # mascara para exponente
    and t0, t2, t0
    lui t2, 0x3D000
    # blt t0, t2, exp_menor
